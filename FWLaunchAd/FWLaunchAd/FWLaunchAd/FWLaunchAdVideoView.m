...
@interface FWLaunchAdVideoView () <UIGestureRecognizerDelegate>
...
@implementation FWLaunchAdVideoView
...
{
    // 需要循环播放
    if(_dynamicAdPlayType == FWLaunchDynamicAdPlayDefault)
    {
...
- (void)observeValueForKeyPath:(NSString *)keyPath ofObject:(id)object change:(NSDictionary<NSKeyValueChangeKey,id> *)change context:(void *)context
{
    if([keyPath isEqualToString:VideoPlayStatus])
    {
        ...
        {
            [[NSNotificationCenter defaultCenter] postNotificationName:FWLaunchAdVideoPlayFailedNotification object:nil userInfo:@{@"videoNameOrURLString":_contentURL.absoluteString}];
        }
    }
}
