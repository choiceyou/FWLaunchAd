...
- (void)dealloc
{
    /**
     ...
     请在广告详情控制器销毁时,发下面通知,告诉FWLaunchAd,广告详情页面已显示完
     */
    [[NSNotificationCenter defaultCenter] postNotificationName:FWLaunchAdDetailPageShowFinishNotification object:nil];
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    /**
     如果你设置了APP从后台恢复时也显示广告,
     当用户停留在广告详情页时,APP从后台恢复时,你不想再次显示启动广告,
     请在广告详情控制器将要显示时,发下面通知,告诉FWLaunchAd,广告详情页面将要显示
     */
    [[NSNotificationCenter defaultCenter] postNotificationName:FWLaunchAdDetailPageWillShowNotification object:nil];
}
